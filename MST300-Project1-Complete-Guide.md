# MST300 Project 1: Active Directory Domain Services - Complete Walkthrough

## Table of Contents
1. [Project Overview](#project-overview)
2. [Prerequisites](#prerequisites)
3. [Architecture](#architecture)
4. [Subnetting Your Assigned Network](#subnetting-your-assigned-network)
5. [Part 1: Resource Group Setup](#part-1-resource-group-setup)
6. [Part 2: Virtual Networks Configuration](#part-2-virtual-networks-configuration)
7. [Part 3: Azure Bastion Setup](#part-3-azure-bastion-setup)
8. [Part 4: Domain Controller VM](#part-4-domain-controller-vm)
9. [Part 5: Active Directory Domain Services](#part-5-active-directory-domain-services)
10. [Part 6: Webserver VM](#part-6-webserver-vm)
11. [Part 7: Client VM](#part-7-client-vm)
12. [Part 8: Virtual Network Peering](#part-8-virtual-network-peering)
13. [Part 9: Joining VMs to Domain](#part-9-joining-vms-to-domain)
14. [Part 10: IIS Configuration](#part-10-iis-configuration)
15. [Part 11: DNS Configuration](#part-11-dns-configuration)
16. [Part 12: User Permissions](#part-12-user-permissions)
17. [Part 13: Testing and Verification](#part-13-testing-and-verification)
18. [Troubleshooting Guide](#troubleshooting-guide)
19. [Project Submission](#project-submission)
20. [Appendix A: Subnetting Quick Reference](#appendix-a-subnetting-quick-reference)
...
**Azure Services Used:** Virtual Machines, Virtual Networks, Azure Bastion, Active Directory
...
AzureBastionSubnet: 131.131.131.32/26  ← Overlaps with first subnet!

Correct:
vnet1-subnet1: 131.131.131.0/26       (0-63)
AzureBastionSubnet: 131.131.131.64/26 (64-127)
```

❌ **Mistake 2: Wrong subnet mask**
```
Wrong:
131.131.131.0/24 for each subnet ← Uses all 256 addresses for one subnet!

Correct:
131.131.131.0/26 ← Uses only 64 addresses, leaving room for others
```

❌ **Mistake 3: Not using all assigned space**
```
Wrong:
Only creating 2 subnets when you need 4

Correct:
Plan all 4 subnets before creating VNets
```
...
1. ❌ Using incorrect naming conventions
2. ❌ Forgetting to restart VMs after DNS changes
3. ❌ Not configuring DNS for vnet2 and vnet3
4. ❌ Skipping Group Policy configuration
5. ❌ Not adding users to Remote Desktop Users group
6. ❌ Using wrong username format for Bastion
7. ❌ Forgetting to create DNS record for webserver
8. ❌ Not modifying IIS default page title
9. ❌ Testing before applying Group Policy updates
10. ❌ Not verifying each step before proceeding
11. ❌ Incorrect subnetting (overlapping addresses)
12. ❌ Using B1s for Domain Controller (use B2s)
...
Congratulations on completing the MST300 Project 1! You've successfully:

✅ Built a complete Active Directory domain environment in Azure  
✅ Configured secure access through Azure Bastion  
✅ Implemented virtual network peering  
✅ Deployed and configured a web server with custom content  
✅ Managed users and permissions through Group Policy  
✅ Demonstrated enterprise networking concepts  
✅ Properly subnetted a /24 network into four /26 subnets

This project simulates real-world enterprise infrastructure and provides hands-on experience with:
...
This guide is created for educational purposes for Seneca College MST300 course students.

---

## Author

Guide created for MST300 - Winter 2025

**Contributors:**
- Students who identified common issues and solutions
- Instructor feedback and requirements

---

**Last Updated:** October 13, 2025  
**Version:** 2.0 (Complete with Subnetting Guide)
